...
If UserName <>"" then
	...
	If NOT rs.EOF then
		...
		If encode(Password) = rs("password") then
...
<link href="/manager/includes/styles_app.css" rel="stylesheet" type="text/css" />
</head>
<body bgcolor="#FFFFFF">
...
<table border="0" cellspacing="0" width="100%" cellpadding="0" height="100%">
  <tr> 
    <td valign="top" align="center"> 
      ...
      <form method="POST" action="default.asp?URL=<%=Server.URLEncode(URL)%>">
