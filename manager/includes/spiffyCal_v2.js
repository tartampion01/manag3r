...
img_Del.src="/intranet/includes/calendar/btn_del_small_gif";
img_Close.src="/intranet/includes/calendar/btn_close_small_gif";
...
function spiffyCalManager() {
	...
	this.matchedFormat="";
	this.DefBtnImgPath='/intranet/includes/calendar/';
...
'MMM-dd-yyyy',
'MMM/dd/yyyy');
	var MONTH_NAMES = new Array('janvier','fevrier','mars','avril','mai','juin','juillet','aout','septembre','octobre','novembre','decembre','jan','fev','mar','avr','mai','juin','juil','aout','sept','oct','nov','dec');
...
function ctlSpiffyCalendarBox(strVarName, strFormName, strTextBoxName, strBtnName, strDefaultValue,strMaxDateValue, intBtnMode) {

	var msNames     = new makeArray0('jan','fev','mar','avr','mai','juin','juil','aout','sept','oct','nov','dec');
...
// put these next 2 lines in when the tiny cal btns seem to randomly disappear		
	...
	function hide() {
		...
		this.visible = false;
		calMgr.swapImg(this,'.imgUp',false);    
		if (this.hideCombos) {toggleCombos('inherit');}
	}
	this.hide=hide;
	...
	function toggleCombos_disabled(showHow){
		var i; var j;
		var cboX; var cboY;
	...
	// EXTRA Private FUNCTIONS This one works fine =================================================
