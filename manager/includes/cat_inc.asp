...
<%If SearchItems<>"" then%>
    <form method="post" action="/includes/default.asp">
	  <td valign="bottom">
        <table border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>Quick Search:</td>
            <td>
              <input type="text" name="Search" value="<%=Session(tableName & "Search")%>">
            </td>
            <td>
              <input type="image" border="0" name="Submit" src="/intranet/images/ok.gif" width="19" height="18" alt="Effectuer la recherche">
              <a href="/includes/?reset"><img src="/intranet/images/ico_cancel.gif" width="18" height="18" border="0" alt="Annuler la recherche"></a>
            </td>
          </tr>
        </table>
...
<%End If%>
    <td valign="middle" align="right"><a href="/includes/details.asp">+ Add New</a></td>
  </tr>
</table>
...
%>
    ...
    <td class="titlebar" width="100%">&nbsp;<%=Count%> items found - <b>page <%=Page%> of <%=LastPage%></b></td>
    <%
Else
%>
    <td class="titlebar" width="100%">&nbsp;No item found</td>
    <%
End If
%>
    <form method="get">
      <td nowrap class="titlebar">&nbsp;Show
...
%>
    <td><a href="/includes/default.asp?page=<%=Page-1%>"><img src="/intranet/images/arrow_left.gif" width="20" height="20" border="0" alt="Previous"></a></td>
    <%
Else
%>
    <td class="titlebar" width="20"><img src="/intranet/images/arrow_left.gif" width="20" height="20" border="0"></td>
    <%
End If
%>
    <td class="titlebar"><b>&nbsp;<%=Page%>&nbsp;</b></td>
<%
If Page <> LastPage And LastPage > 1 then
%>
    <td width="20"><a href="/includes/default.asp?page=<%=Page+1%>"><img src="/intranet/images/arrow_right.gif" width="20" height="20" border="0" alt="Next"></a></td>
    <%
Else
%>
    <td class="titlebar" width="20"><img src="/intranet/images/arrow_right.gif" width="20" height="20" border="0"></td>
    <%
End If
%>
      </tr>
...
If Session(tableName & "OrderBy")=Headers(i,0) then
	orderImage="&nbsp;<img src='/intranet/images/" & Session(tableName & "Sort") & ".gif' border=0 width=8 height=7>"	
Else
	orderImage=""
End IF
%>
	<th onMouseOver="this.className='over';" onMouseOut="this.className='';" onClick="this.children.tags('A')[0].click();" class="thnormal" nowrap>
	<a href="/includes/default.asp?OrderBy=<%=Headers(i,0)%>"><%=Headers(i,1)&orderImage%></a></th>
    <%
Next
%>
...
For i = 0 to Ubound(Headers,1)
	If Headers(i,2) then
		newCombo="<Select name='" & Headers(i,0) & "' OnChange=""document.location.href='default.asp?" & Headers(i,0) & "=' + document.go." & Headers(i,0) & ".options[document.go." & Headers(i,0) & ".selectedIndex].value;"">" & VbCrLf
...
Else
	TRStyle = "high"
End If
Execute("overdue=" & overdue_condition)
If overdue then
	TRStyle = "overdue"
End If
...
If Page <> 1 And LastPage > 1 then
%>
    <td width="20"><a href="/includes/default.asp?page=<%=Page-1%>"><img src="/intranet/images/arrow_left.gif" width="20" height="20" border="0"></a></td>
    <%
Else
%>
    <td class="titlebar" width="20"><img src="/intranet/images/arrow_left.gif" width="20" height="20" border="0"></td>
...
If Page <> LastPage And LastPage > 1 then
%>
    <td width="20"><a href="/includes/default.asp?page=<%=Page+1%>"><img src="/intranet/images/arrow_right.gif" width="20" height="20" border="0"></a></td>
    <%
Else
%>
    <td class="titlebar" width="20"><img src="/intranet/images/arrow_right.gif" width="20" height="20" border="0"></td>
