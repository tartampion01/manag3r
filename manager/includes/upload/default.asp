...
Dim DestinationPath
DestinationPath = Server.mapPath("/intranet/pdf/")

'Using Huge-ASP file upload
'Dim Form: Set Form = Server.CreateObject("ScriptUtils.ASPForm")
'Using Pure-ASP file upload
Dim Form: Set Form = New ASPForm %><!--#include virtual="/intranet/includes/upload/_upload.asp" --><% 
...
If Form.State = fsCompletted Then 'Completted
  ...
  if Form.State = 0 then
	...
	response.write "<br>Desc:" & Form("description1")
